...
namespace Common
{
    class PlayCtrl
    {
        ...
        public const int PLAYM4_OPEN_FILE_ERROR_MULTI = 24; //open file error, stream type is multi
        public const int PLAYM4_OPEN_FILE_ERROR_VIDEO = 25; //open file error, stream type is video
        ...
        // the following macro for the struct HIK_MEDIAINFO
        public const int FOURCC_HKMI = 0x484B4D49;	// "HKMI" HIK_MEDIAINFO stuct tag
        // system package format
        public const int SYSTEM_NULL = 0; // without system layer, pure audio streams or video streams 	
        public const int SYSTEM_HIK = 1; // HIK file layer
        public const int SYSTEM_MPEG2_PS = 2;// PS package
        public const int SYSTEM_MPEG2_TS = 3;// TS package
        public const int SYSTEM_RTP = 4;// rtp package

        // video encode type
        public const int VIDEO_NULL = 0;// no videos
        public const int VIDEO_H264 = 1;// standard H.264 and HIK H.264
        public const int VIDEO_MPEG4 = 3;// standard MPEG4

        // audio encode type
        public const int AUDIO_NULL = 0;// no audios
        public const int AUDIO_ADPCM = 4096;// ADPCM 
        public const int AUDIO_MPEG = 8192;// MPEG series audios, the decoder can decode various MPEG audios adaptively.
        ...
        public struct HIK_MEDIAINFO
        {
            ...
            public ushort media_version; // version:indicate this struct information version, now is 0x0101,also 1.01 ,01:major;01:minor。
            public ushort device_id; // device ID，for trace and analysis	

            public ushort system_format; // system package format
            public ushort video_format; // video encode type 

            public ushort audio_format;// audio encode type
            public byte audio_channels;// channel number  
            public byte audio_bits_per_sample;// bits per sample
            public uint audio_samplesrate;// sample rates 
            public uint audio_bitrate;// compressed audio bit rate ,unit:bit
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.U4)]
            public uint[] reserved;// reserve
        ...
        // user-defined functions inerface
