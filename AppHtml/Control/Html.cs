...
namespace AppHtml.Control
{
    ...
    public class Html
    {
        ...
        public string Input(string Title, string Name, object Attribute = null, int Col = 6)
        {
            ...
            //    <input type="text" class="form-control" name="Member_Name" v-model="Member_Name" placeholder="请输入 会员名称" />
            //</div>
            ...
            _Input_Attribute.Add("v-model", Name);
        ...
        public string Select(string Title, string Name, Func<string> FuncOpetion, object Attribute = null, int Col = 6)
        {
            ...
            //    <select class="form-control" name="Member_Sex" v-model="Member_Sex">
            ...
            _Select_Attribute.Add("v-model", Name);
        ...
        public string FindBack(string Title, string Text, string ID, string Url, string FindClick, string RemoveClick, int Col = 6, string Placeholder = null, bool KO = true, bool Readonly = true)
        {
            ...
            //        <input type="text" class="form-control" name="User_Name" v-model="User_Name" placeholder="请选择 用户名称" readonly="readonly" />
            //        <input type="text" class="form-control" style="display:none" name="Member_UserID" v-model="Member_UserID" />
            ...
            //        vueApp.findBack(row,'User')
            //    });">
            //                <i class="fa fa-search"></i>
            //            </button><button type="button" class="btn btn-outline btn-default" onclick="vueApp.findBack(null,'User');"><i class="fa fa-close"></i></button>
            //        </span>
            //    </div>
            //</div>
            ...
            if (KO)
            {
                _Text_KoHtml = " v-model=\"" + Text + "\"";
                _ID_KoHtml = " v-model=\"" + ID + "\"";
            }
        ...
        {
            return $"<upload-image col=\"{Col}\" title=\"{Title}\" filedname=\"{Name}\" isshowupbtn=\"{(IsUpBtn ? "1" : "0")}\" tips=\"{Tips}\" v-bind:filed=\"{Name}\"></upload-image>";
        }
        ...
        {
            return $"<upload-file col=\"{Col}\" title=\"{Title}\" filedname=\"{Name}\" tips=\"{Tips}\" v-bind:filed=\"{Name}\"></upload-file>";
        }
        ...
        public string UploadImageMultiple(string Title, string Name, int Col, string EventChange, string Tips)
        {
            ...
            //            <img src="~/Resource/HzyUI/img/login.jpg" height="140" v-show="Member_Photo" v-bind:src="Member_Photo" />
            //            <img src="~/Resource/HzyUI/img/login.jpg" height="140" v-show="Member_Photo" v-bind:src="Member_Photo" />
            //            <img src="~/Resource/HzyUI/img/login.jpg" height="140" v-show="Member_Photo" v-bind:src="Member_Photo" />
            //            <img src="~/Resource/HzyUI/img/login.jpg" height="140" v-show="Member_Photo" v-bind:src="Member_Photo" />
            //        </div>
            ...
            sb.Append($"            <!--<img height=\"140\" v-show=\"{Name}\" v-bind:src=\"{Name}\" />-->");
            sb.Append("        </div>");
        ...
        public string UploadFileMultiple(string Title, string Name, int Col, string EventChange, string Tips)
        {
            ...
            sb.Append("    <div class=\"hzy-upfile\">");
            sb.Append("        <div class=\"hzy-upfile-item\">");
            sb.Append("            <!--<a v-show=\"" + Name + "\" v-bind:href=\"" + Name + "\" v-bind:title=\"" + Name + "\" target=\"_blank\">{{" + Name + "}}</a>-->");
            sb.Append("        </div>");
            sb.Append("        <div class=\"hzy-upfile-shade\" onclick=\"$('input[name=" + Name + "]').click();\">" + Tips + "</div>");
        ...
        public string Textarea(string Title, string Name, int Col, object Attribute, string Placeholder)
        {
            ...
            //    <textarea class="form-control" v-model="WebSiteLabel_Remark" placeholder="请输入备注" rows="5"></textarea>
            //</div>
            ...
            _Textarea_Attribute.Add("v-model", Name);
